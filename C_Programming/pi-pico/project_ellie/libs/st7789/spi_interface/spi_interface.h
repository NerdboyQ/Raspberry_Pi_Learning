...
#define SPI_PIN_DC   0 // GPIO0 - DC pin //20  // Data/Command
#define SPI_PIN_RST  1 // GPIO1 - RT pin //21  // Reset
#define SPI_PIN_SCK  2 // GPIO2 SPI0 SCK // 18
#define SPI_PIN_MOSI 3 // GPIO3 SPI0 Tx  // 19
#define SPI_PIN_MISO 4 // GPIO4 SPI0 Rx  // 16
#define SPI_PIN_CS   5 // GPIO5 SPI0 CSn // 17
 ...
 * @param backlight_pin: target display backlight pin
 * @param g_st7789_handle: st7789 display handle
 * 
